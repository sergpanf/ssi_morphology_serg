...
def main():
    ...
    INPUT_PREDICTED_FILE =  "../sp_new_data/fileB__NT_predicted_2026-05-29_subphrases_ep440_VETOED"
    OUTPUT_FILE =           "../sp_new_data/fileB__NT_predicted_2026-05-29_subphrases_ep440_VETOED_reformatted"
