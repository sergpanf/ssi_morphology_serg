...
main(["-mo", "train", "-i", "input_NT_nlcgpS", "-o", "output_NT_XYs", "-ep", "20", "-l", "10", "-lr", "0.0001", "-et", "True"]) # using older output file, as XY-phrase-pattern will stay the same and the word count of the input file stays equal with it


# %% F-SCORE of the MODEL
file = "../sp_evaluation_results_transformer/input_NT_nlcgpS_output_NT_XYs_ONE_DATASET/results_10seq_len_0.0001lr_512embsize_8nhead_transformer_0.1dropout_128_batchsize_20epochs_3beamsize.txt"
